...
The **sample.cos** file prints out distant-dependent **<cos&theta;<sup>n</sup>>** of water (n=1,2,3,4). The **sample.dip** file gives the z-component of polarization density of water in along z-direction.
